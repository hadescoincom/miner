...
*/
__attribute__((reqd_work_group_size(wgSize, 1, 1)))
__kernel void hdsHashIII_seed (__global ulong8 * buffer0,
				__global ulong8 * buffer1,
...
*/
__attribute__((reqd_work_group_size(wgSize, 1, 1)))
__kernel void hdsHashIII_R1 (	__global ulong8 * buffer0,
				__global ulong8 * buffer1,
				__global uint * counters,
				__global uint * results,
				ulong4 prePow) {
...
*/
__attribute__((reqd_work_group_size(wgSize, 1, 1)))
__kernel void hdsHashIII_R2 (	__global ulong8 * buffer0,
				__global ulong8 * buffer1,
				__global uint * counters,
				__global uint * results,
				ulong4 prePow) {
...
*/
__attribute__((reqd_work_group_size(wgSize, 1, 1)))
__kernel void hdsHashIII_R3 (	__global ulong8 * buffer0,
				__global ulong8 * buffer1,
				__global uint * counters,
				__global uint * results,
				ulong4 prePow) {
...
*/
__attribute__((reqd_work_group_size(wgSize, 1, 1)))
__kernel void hdsHashIII_R4 (	__global ulong8 * buffer0,
				__global ulong8 * buffer1,
				__global uint * counters,
				__global uint * results,
				ulong4 prePow) {
...
*/
__attribute__((reqd_work_group_size(wgSize, 1, 1)))
__kernel void hdsHashIII_R5 (	__global ulong8 * buffer0,
				__global ulong8 * buffer1,
				__global uint * counters,
				__global uint * results,
				ulong4 prePow) {

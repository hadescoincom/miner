...
void hdsStratum::getWork(WorkDescription& wd, uint8_t* dataOut) {
...
hdsStratum::hdsStratum(string hostIn, string portIn, string apiKeyIn, bool debugIn) : res(io_service), context(boost::asio::ssl::context::tlsv12)  {
